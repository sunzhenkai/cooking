...
public class JsonUtil {
    ...
    public static String toJson(JsonNode object, boolean removeNullNode) throws JsonProcessingException {
        if (removeNullNode) {
    ...
    public static <T> T fromJson(String jsonStr, Class<T> objClass) throws JsonProcessingException {
        try {
    ...
    public static JsonNode fromJson(String jsonStr) throws JsonProcessingException {
