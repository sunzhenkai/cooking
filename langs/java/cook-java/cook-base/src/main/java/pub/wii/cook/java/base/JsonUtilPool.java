...
public class JsonUtilPool {
    ...
    private static PooledObjectFactory factory = new ObjectMapperPoolFactory();
    private static ObjectPool<ObjectMapper> pool = new GenericObjectPool<>(factory, config);
    ...
    public static String toJson(Object object) {
        try {
            ObjectMapper mapper = pool.borrowObject();
    ...
    public static <T> T fromJson(String jsonStr, Class<T> objClass) {
        try {
            ObjectMapper mapper = pool.borrowObject();
            T res = mapper.readValue(jsonStr, objClass);
            pool.returnObject(mapper);
            return res;
        } catch (Exception e) {
...
class ObjectMapperPoolFactory extends BasePooledObjectFactory<ObjectMapper> {
